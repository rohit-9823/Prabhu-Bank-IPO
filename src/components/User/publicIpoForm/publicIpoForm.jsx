...
export default function Publicipo1(props) {
  ...
  const handleSubmit1 = (values) => {
    ...
    finalValue.perMunicipalityId =
      finalValue.permanentAddress.localMunicipality;
        ...
        httpClient
          ...
          .then((resp) => {
            ...
            Swal.fire({
              ...
              if (result.isConfirmed) {
                props.history.push("/payment", paymentData);
                // window.open("http://www.esewa.com.np");
              }
            });
          })
          .catch((err) => {
  ...
  const handleprovincedata = (value, allvalue) => {
    ...
    httpClient.POST("api/ipo/get-location", data).then((res) => {
      let datas = res.data.data.district.map((values) => {
        return {
  ...
  const getprovinces = () => {
    ...
    httpClient
      ...
      .then((res) => {
        let newvalue = [
          {
            value: res.data.data.provinceid,
            label: res.data.data.province,
          },
        ];
              ...
              {(allvalues, errors, touched, setFieldValue) => (
                <div>
                    ...
                    <div className="input-gender">
                      <div className="apply-share-form personal-info-form">
                        ...
                        <div className="boid-main2">
                          <label className="boid-label" htmlFor="">
                            तपाईंसँग डिम्याट खाता छ ?
                          </label>
                          ...
                          {boidyes ? (
                            ...
                            <div className="else-boid-content">
                              <p className="boid-label">
                                हजुरले आफ्नो डिम्याट खाता अनलाइनबाटै खोल्न
                                सक्नुहुनेछ । यसका लागि प्रभु क्यापिटल लिमिटेडको
                                तलको लिंकमा क्लिक गर्नुहोला ।{" "}
                              </p>
                              <a href="https://www.prabhucapital.com/online-demat-account-opening">
                                Click here{" "}
                              </a>
                            </div>
                          )}
                  ...
                  {props.value == "agent1" ? (
                    <div className="apply-share-form personal-info-form">
                      <div className="ipo-issued-brief iib-border-bottom">
                        <p id="ipo-issued-name">Voucher Upload</p>
                      </div>
                      <div>
                        <Form>
                          <div className="share-apply-form1">
                            ...
                            <div className="form-input-share">
                              <div>
                                <label for="file">Voucher upload</label>
                              </div>
                              <div className="upload-btn-wrapper">
                                <button className="ctzn-up-fi-btn">
                                  <div>
