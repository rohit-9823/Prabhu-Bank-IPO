      ...
      <div className="apply-for-issue1-1">
        ...
        >
          ...
          <>
                      ...
                      <button
                        ...
                        onClick={() => {
                          new Swal({
                            ...
                            // imageUrl: details.citizenshipFrontImage,
                            imageWidth: 400,
                            imageHeight: 200,
            ...
            <div className="apply-share-form personal-info-form ">
              <div className="ipo-issued-brief iib-border-bottom">
                <p id="ipo-issued-name">Uploaded File Details</p>
              </div>
              <div>
                <div className="view-uploaded-file grid">
                  ...
                  <div className="form-input-share">
                    ...
                    <div className="ctzenshp-img-frame2">
                      <img src={`${baseurl}api/applicant/download/BC/${details.birthCertificateImage}`} alt="citizenship img" />
                    </div>
                  </div>
                  :null}
                </div>
